            ...
            children: [
              Stack(
                ...
                children: [
                  ...
                  Icon(
                    controller.isTransferring.value ? Icons.upload_file : Icons.cloud_done_outlined,
                    size: 40,
                    color: AppColors.cyanBlue,
                  ).animate(target: controller.isTransferring.value ? 1 : 0).shimmer(),
                ],
              ),
              const SizedBox(height: 16),
              Text(
  ...
  Widget _buildBottomAction(FileSharingController controller) {
    return Padding(
      ...
      child: Obx(() => ElevatedButton(
            onPressed: controller.isTransferring.value ? null : () => controller.startTransfer(),
            ...
            child: Text(
              controller.isTransferring.value ? 'TRANSFER IN PROGRESS' : 'BROADCAST TO MESH',
